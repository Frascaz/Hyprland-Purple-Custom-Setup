# Hyprland Purple Custom Setup
> Silly ass hyprland rice with custom animations.
...
Copy all the config file in .config, but u need to change the location of all the pictures used

## Meta

Luca Fraschini – [@Frascazzz](https://www.instagram.com/luca_frascaz/) – frascaz@outlook.it
